  ...
  <div id="content" class="full-width">               
    ...
    <div id="gallery-container" class="gallery-4-columns isotope clearfix">
      <div class="type-gallery-item hentry gallery-item isotope-item care">
        <a class="pretty-photo" href="images/Refined/gallery/g1.jpg"><img src="images/Refined/gallery/small/g1.jpg" alt="Details"></a>
        <h5 class="item-title">Toyota Innova</h5>
      </div>            
      <div class="type-gallery-item hentry gallery-item isotope-item care">
        <a class="pretty-photo" href="images/Refined/gallery/g2.jpg"><img src="images/Refined/gallery/small/g2.jpg" alt="Details"></a>
        <h5 class="item-title">Toyota Innova</h5>
      </div>            
      <div class="type-gallery-item hentry gallery-item isotope-item care">
        <a class="pretty-photo" href="images/Refined/gallery/g3.jpg"><img src="images/Refined/gallery/small/g3.jpg" alt="Details"></a>
        <h5 class="item-title">Toyota Innova</h5>        
      </div>                    
      <div class="type-gallery-item hentry gallery-item isotope-item donations">
        <a class="pretty-photo" href="images/Refined/gallery/g4.jpg"><img src="images/Refined/gallery/small/g4.jpg" alt="Details"></a>
        <h5 class="item-title">Toyota Fortuner</h5>
      </div>
      <div class="type-gallery-item hentry gallery-item isotope-item donations">
        <a class="pretty-photo" href="images/Refined/gallery/g5.jpg"><img src="images/Refined/gallery/small/g5.jpg" alt="Details"></a>
        <h5 class="item-title">Toyota Fortuner</h5>
      </div>           
      <div class="type-gallery-item hentry gallery-item isotope-item donations">
        <a class="pretty-photo" href="images/Refined/gallery/g6.jpg"><img src="images/Refined/gallery/small/g6.jpg" alt="Details"></a>
        <h5 class="item-title">Toyota Fortuner</h5>
      </div>
      <div class="type-gallery-item hentry gallery-item isotope-item pharmacy">
        <a class="pretty-photo" href="images/Refined/gallery/g7.jpg"><img src="images/Refined/gallery/small/g7.jpg" alt="Details"></a>
        <h5 class="item-title">Ford Transits</h5>
      </div>
      <div class="type-gallery-item hentry gallery-item isotope-item treatment">
        <a class="pretty-photo" href="images/Refined/gallery/g8.jpg"><img src="images/Refined/gallery/small/g8.jpg" alt="Details"></a>
        <h5 class="item-title">Ford Everest</h5>
      </div>
      <div class="type-gallery-item hentry gallery-item isotope-item treatment">
        <a class="pretty-photo" href="images/Refined/gallery/g9.jpg"><img src="images/Refined/gallery/small/g9.jpg" alt="Details"></a>
        <h5 class="item-title">Ford Everest</h5>
      </div>
      <div class="type-gallery-item hentry gallery-item isotope-item treatment">
        <a class="pretty-photo" href="images/Refined/gallery/g9.jpg"><img src="images/Refined/gallery/small/g10.jpg" alt="Details"></a>
        <h5 class="item-title">Ford Everest</h5>
      </div>
